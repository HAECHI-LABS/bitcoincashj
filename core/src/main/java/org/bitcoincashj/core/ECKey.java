...
public class ECKey implements EncryptableItem {
     ...
     *
     * @throws org.bitcoincashj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
    ...
    public static boolean verifySchnorr(byte[] sigHash, SchnorrSignature signature, byte[] pubKey) {
        return SchnorrSignature.schnorr_verify(sigHash, pubKey, signature.getSignature());
    }
     ...
     *
     * @throws org.bitcoincashj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */

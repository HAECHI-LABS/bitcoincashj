...
public class PeerGroup implements TransactionBroadcaster {
    ...
    @GuardedBy("lock")
    private int stallMinSpeedBytesSec = Block.HEADER_SIZE * 10;
    @Nullable
    ...
    protected Peer selectDownloadPeer(List<Peer> peers) {
        ...
        final int PREFERRED_VERSION = params.getProtocolVersionNum(NetworkParameters.ProtocolVersion.BLOOM_FILTER_BIP111);

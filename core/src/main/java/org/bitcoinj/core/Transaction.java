...
public class Transaction extends ChildMessage {
    ...
    public Sha256Hash getTxId() {
        if (cachedTxId == null) {
            cachedTxId = Sha256Hash.wrapReversed(Sha256Hash.hashTwice(unsafeBitcoinSerialize()));
        }
        return cachedTxId;
    }
    ...
    public String toString(@Nullable AbstractBlockChain chain, @Nullable CharSequence indent) {
        ...
        s.append(size).append("size: ").append(size).append(" bytes\n");
        if (updatedAt != null)
    ...
    public TransactionInput addSignedInput(TransactionOutPoint prevOut, Script scriptPubKey, ECKey sigKey,
        ...
        if (ScriptPattern.isP2PK(scriptPubKey)) {
            ...
            throw new ScriptException(ScriptError.SCRIPT_ERR_PUBKEYTYPE, "Don't know how to sign for this kind of scriptPubKey: " + scriptPubKey);
        }
        return input;
    }
